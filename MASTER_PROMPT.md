...
- On Vercel Hobby, the scheduled shared-source refresh runs once daily at `0 12 * * *`; administrators retain an explicit on-demand **Refresh now** action. Do not configure a schedule that exceeds the active hosting plan's supported frequency.
