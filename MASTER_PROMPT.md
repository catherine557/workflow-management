...
- Use a minimum 14px base text size for body copy and controls where practical; metadata may be smaller but must remain legible. Primary touch targets are at least 40px high.
